...
-- 
-- IMPORTANT NOTES:
-- 1. This script matches the schema in bola-ddl.sql exactly
...
-- 6. ON CONFLICT clauses use UNIQUE constraints (uq_team_stats_game_team, uq_appearances_game_player)
-- ============================================================================
